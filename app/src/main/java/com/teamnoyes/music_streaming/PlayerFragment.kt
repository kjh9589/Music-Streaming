...
import com.teamnoyes.music_streaming.databinding.FragmentPlayerBinding
import com.teamnoyes.music_streaming.service.MusicDto
import com.teamnoyes.music_streaming.service.MusicService
        ...
        binding?.let { binding ->
            player?.addListener(object : Player.Listener {
                override fun onIsPlayingChanged(isPlaying: Boolean) {
                    ...
                    if (isPlaying) {
                        binding.playControlImageView.setImageResource(R.drawable.pause_48)
                    } else {
                        binding.playControlImageView.setImageResource(R.drawable.play_arrow_48)
                    }
                }
